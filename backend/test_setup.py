...
for package, import_name in dependencies:
    try:
        ...
        print(f"    [FAIL] {package} - run: pip install {package}")
        all_ok = False
...
if os.path.exists("data/faiss_index/index.faiss"):
    print("    [OK] FAISS index found")
else:
    print("    [FAIL] FAISS index not found")
...
print("\n" + "=" * 60)
print("[SUCCESS] All checks passed! Ready to start the backend.")
print("=" * 60)
